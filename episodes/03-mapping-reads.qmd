...
The structure of going through main important commands during mapping is good, imo.
...
Might also be good to explain a little bit about how the FASTQ files result from experiments (see overview picture below also).
