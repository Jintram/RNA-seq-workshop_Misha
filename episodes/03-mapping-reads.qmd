...
1. What do you see?
2. Use `samtools view` command, piped into a common Unix program, to inspect the first 10 lines of the file. 
:::
...
2. `samtools idxstats` shows us how many reads were mapped to each chromosome of the reference genome. Useful to detect whether the entire genome is evenly covered, or that there may be overrepresentation on e.g. the mitochondrial DNA.
:::
