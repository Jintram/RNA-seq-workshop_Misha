...
#### Furthermore
- We need to point out that RNA ≠ protein, so validation is important.
- Do we want to include normalized effect sizes? Might be pretty useful, but it's also yet more content.
...
- Add links to reading materials?
	...
	- https://master.bioconductor.org/packages/release/workflows/html/rnaseqGene.html
		- (More accessible, according to Love.)
...
<mwadd>TO DO: add important caveat here: RNA-seq is nice but really needs validation because fo noise and RNA ≠ protein expression.</mwadd>
