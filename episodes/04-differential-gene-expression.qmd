...
In this example, we see very nice separation of our wildtype and mutant samples. Experiment succes! ... or is it? Upon closer inpection, we can see that gender of our samples also separates our samples in the same way. It turns out that all wildtypes were male mice, and all mutants were female. We will therefore never now if differentially expressed genes are caused by the genotype, or simply by the gender of the mice. This is an obvious experimental design flaw, and should have been caught before sampling. Yet, it happens!
